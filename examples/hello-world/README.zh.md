...
这些图是 `hello-world` 自己目录下的 crate 专属学习资料，用来说明它在 Neo N4 中的位置、自己负责的技术边界、内部工作流，以及数据如何流经它。
...
| 文件 | 为什么重要 | 公开 API | 测试 |
| --- | --- | ---: | ---: |
| `src/lib.rs` | crate 根、公开导出和顶层文档 | 2 | 2 |
...
| --- | --- |
| 类型 | 未扫描到公开符号 |
| 函数 | dispatch <br> invoke_entry <br> invoke |
| Trait | 未扫描到公开符号 |
| 常量 | 未扫描到公开符号 |
