...
namespace Neo.Compiler
{
    public class CompilationOptions
    {
        ...
        /// <summary>
        /// Relative path from the generated RISC-V crate directory to the
        /// neo-riscv-vm/crates directory. Used for Cargo.toml path dependencies.
        /// If null, defaults to "../../crates".
        /// </summary>
