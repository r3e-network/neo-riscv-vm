...
internal static class AdapterTestProtocolSettings
{
    ...
    /// <summary>
    /// Mainnet protocol settings matching config.mainnet.json exactly.
    /// Uses the real 21-member standby committee and 7 validators.
    /// </summary>
    internal static readonly ProtocolSettings Mainnet = ProtocolSettings.Default with
    {
        Network = 860833102u,
        AddressVersion = 53,
        ...
        Hardforks = new System.Collections.Generic.Dictionary<Neo.Hardfork, uint>
        {
            [Neo.Hardfork.HF_Aspidochelone] = 1730000,
            [Neo.Hardfork.HF_Basilisk] = 4120000,
            [Neo.Hardfork.HF_Cockatrice] = 5450000,
            [Neo.Hardfork.HF_Domovoi] = 5570000,
            [Neo.Hardfork.HF_Echidna] = 7300000,
