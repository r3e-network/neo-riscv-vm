# nep17-token Source-Level Learning Guide
...
| Test | File |
| --- | --- |
| `nep17_metadata_dispatches` | `src/lib.rs` |
| `nep17_balanceOf_returns_zero` | `src/lib.rs` |
| `nep17_rejects_invalid_methods` | `src/lib.rs` |
