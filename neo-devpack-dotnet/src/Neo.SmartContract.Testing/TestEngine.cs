...
namespace Neo.SmartContract.Testing
{
    public class TestEngine
    {
        ...
        /// <summary>
        /// The RISC-V VM bridge used when Backend == RiscV.
        /// Set by test infrastructure (e.g. DebugAndTestBase) after reading
        /// the NEO_TEST_BACKEND environment variable.
        /// </summary>
        public IRiscvVmBridge? RiscVBridge { get; set; }

        /// <summary>
        /// Registry of contract hash to .polkavm binary for RISC-V execution.
        /// Retained for backward compatibility with test setups that populate it,
        /// but no longer used by the execution path (tests execute through the
