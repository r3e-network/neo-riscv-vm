...
//!
//! Wraps role assignment queries (state validator, oracle, neo holder, etc.).
use alloc::vec::Vec;

use neo_riscv_abi::{StackValue, stack_value_as_fixed_bytes, stack_value_into_items};
