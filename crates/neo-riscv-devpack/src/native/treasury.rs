//! Bindings to the committee treasury native contract.
//!
//! Wraps treasury asset queries.
...
/// Native contract script hash for this contract (`TREASURY_HASH`).
...
/// Invoke the native contract `treasury_on_nep17_payment` method.
...
/// Invoke the native contract `treasury_on_nep11_payment` method.
