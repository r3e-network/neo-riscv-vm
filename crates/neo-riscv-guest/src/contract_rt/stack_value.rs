...
pub use neo_riscv_abi::{
    ...
    TAG_INTEROP, TAG_ITERATOR, TAG_MAP, TAG_NULL, TAG_POINTER, TAG_STRUCT, byte_sequence_bytes,
    byte_sequence_len, concat_splice_values, default_value_for_type_tag,
    new_array_default_value_for_type_tag, normalize_stack_item_type_tag, slice_splice_value,
